...
class joinMember extends Component{
    ...
    render(){
        ...
        else if(this.state.termsService && this.state.termsPrivacy){
            return(
                <Fragment>
                <Helmet>
                ...
                <div className="join__wrap">
                    ...
                    <header className="join__header">
                        ...
                        <li className="join__process-item"><span className="join__process-text--step material-icons">step1</span><span className="join__process-text">약관동의</span></li>
                        <li className="join__process-item is-current"><span className="join__process-text--step material-icons">step2</span><span className="join__process-text">개인정보입력</span></li>
