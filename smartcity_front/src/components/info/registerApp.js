                ...
                <div className="join__wrap">
                    <div className="join__inner">
                        <header className="join__header">
                            <h1 className="join__title"><span className="join__title--top">CITY DATA HUB</span>어플리케이션 등록</h1>
                        </header>
                            ...
                            <div className="join__form">
                                <fieldset>
                                    ...
                                    <div className="join__row">
                                        ...
                                        <input id="redirectUri" className="join__input input" type="text" name='redirectUri' onBlur={checkUri} required/>
                                        <div className="warning_msg" id="redirectUriMsg" ref='uriMsg' style={{display:'none'}}></div>
                                    </div>
                                    <div className="join__bottom">
                                        <a className="button button__primary" type="button" onClick={submit} href='#'>등록하기</a>
