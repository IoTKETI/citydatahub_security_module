            ...
            <div className="join__wrap">
                <div className="join__inner">
                    <header className="join__header">
                        <h1 className="join__title"><span className="join__title--top">CITY DATA HUB</span>관리자 계정 관리</h1>
                    </header>
                    <main className="application__main_table">
                        ...
                        <div className="join__bottom" style={{marginTop: '10px'}}>
                            <Link to = '/signup/joinAdminStep1'>
                            <button className="button button__primary" type = "button" style ={{width: '200px',textAlign: 'center',backgroundColor: '#5e4b4e',cursor:'pointer'}}>관리자 계정 추가</button>
                            </Link>
                            <Link to ='/index'>
                            <button className="button button__primary" type="button" onClick={this.DeleteAdmin.bind(this)} style={{width: '200px', textAlign: 'center'}} >적용</button>
                            </Link>
