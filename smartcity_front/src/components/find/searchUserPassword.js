                ...
                <div className="join__wrap">
                    <div className="join__inner">
                        <header className="join__header">
                            ...
                            <h1 id="findPwdTitle" className="join__title">비밀번호 찾기</h1>
                        </header>
                        <main className="login" style={{marginTop:'-70px'}}>
                            <div id="findPwdInput" style={{display: 'inline'}}>
                                <div className="join__row">
                                    ...
                                    <label className="join__label" style={{marginTop:'15px'}}> 아이디
                                        <input id="findPwdIdInput" className="join__input input" name="id" placeholder=" 사용자 아이디" onChange={onChangeHandler} required/>
                                    </label>
                                    <div className="warning_msg" ref="idMsg" style={{display:'none'}}/>
                                    <label className="join__label" style={{marginTop:'10px'}}> 이메일 주소
                                        <input id="findPwdEmailInput" className="join__input input" type="email" name="email" placeholder=" example@example.com" onChange={onChangeHandler} required/>
                                    </label>
                                    <div className="warning_msg" ref="emailMsg" style={{display:'none'}}/>
                                </div>
                                    {/* sms를 통한 인증 미지원
                                <div className="join__row">
                            ...
                            <div className="join__bottom">
                                <a id="findPwdConfirm" className="button button__primary" onClick={submit} href="#">확인</a>
                            </div>
                            {/* <li className="menu__item"><a className="menu__link" href="#none" onClick="showFindId();">아이디 찾기</a></li> */}
                            <a style={{textAlign:'left', marginLeft:'-5px'}} className="menu__link" href="searchUserId">아이디 찾기</a>
                            <Footer/>
                        </main>
                    </div>
                </div>
